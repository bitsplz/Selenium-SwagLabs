...
public class LoginTests extends BaseTest{
    ...
    @Test(description = "Case 1: Verify user should Log in Successfully Clicking button")
    public void login(){
    ...
    @Test(description = "Case 2: Verify user should Log in Successfully pressing Enter")
    ...
    @Test(description = "Case 3: Verify user should Log out Successfully", priority = 5)
    public void logout(){
        loginPage.login(properties.getProperty("username"), properties.getProperty("password"),false);
        loginPage.logout();
    ...
    @Test(description = "Case 4: Verify user should not Log in with invalid email")
    ...
    @Test(description = "Case 5: Verify user should not Log in with invalid password")
