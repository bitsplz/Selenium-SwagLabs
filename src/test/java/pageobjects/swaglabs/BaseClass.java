...
public class BaseClass {
    ...
    //protected String validSocialplatforms[] = {"facebook", "twitter", "linkedin"};
    ...
    private By facebookLink = new By.ByXPath("//a[contains(text(),'Facebook')]");
    private By linkedinLink = new By.ByXPath("//a[contains(text(),'LinkedIn')]");
    private By twitterLink = new By.ByXPath("//a[contains(text(),'Twitter')]");
