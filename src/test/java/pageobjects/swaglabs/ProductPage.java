...
public class ProductPage extends BaseClass{
    private By productNameXpath = new By.ByXPath("//div[@class='inventory_details_name large_size']");
    private By addToCartButton = new By.ByXPath("//button[@class='btn btn_primary btn_small btn_inventory']");
    private By removeFromCartButton = new By.ByXPath("//button[@class='btn btn_secondary btn_small btn_inventory']");
